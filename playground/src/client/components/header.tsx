...
import type { ApiResult, ToolMode, VisNode } from "../lib/types.ts";
...
const styles = {
	header: {
		...
		height: "68px",
		background:
			"linear-gradient(100deg, rgba(6, 10, 16, 0.98) 0%, rgba(9, 16, 26, 0.9) 60%, rgba(7, 12, 20, 0.98) 100%)",
	...
	logoIcon: {
		padding: "9px",
		background:
			"linear-gradient(135deg, rgba(42, 242, 255, 0.2), rgba(56, 247, 201, 0.18))",
		borderRadius: "14px",
		display: "flex",
		alignItems: "center",
	...
	pathInfo: {
		...
		padding: "8px 14px",
		background:
			"linear-gradient(120deg, rgba(14, 22, 36, 0.9), rgba(18, 30, 45, 0.9))",
		borderRadius: "10px",
		fontSize: "13px",
		border: `1px solid ${COLORS.borderSubtle}`,
	...
	button: {
		padding: "8px 16px",
		background:
			"linear-gradient(180deg, rgba(18, 30, 45, 0.9), rgba(12, 20, 32, 0.95))",
		border: `1px solid ${COLORS.borderSubtle}`,
		borderRadius: "10px",
		color: COLORS.textMain,
		fontSize: "13px",
		...
		cursor: "pointer",
		transition:
			"background-color 0.2s, border-color 0.2s, color 0.2s, box-shadow 0.2s, transform 0.2s",
	},
	buttonPrimary: {
		...
		borderRadius: "9999px",
		boxShadow:
			"0 12px 24px rgba(42, 242, 255, 0.3), 0 0 18px rgba(56, 247, 201, 0.25)",
	},
	buttonDanger: {
	...
	modalContent: {
		background:
			"linear-gradient(160deg, rgba(10, 16, 26, 0.96), rgba(12, 20, 32, 0.98))",
		padding: "24px",
		borderRadius: "16px",
		minWidth: "400px",
		...
		<header className="ray-header" style={styles.header}>
			...
			{showOpenModal && (
				...
				>
					...
					>
						<h2 id="open-database-title" style={styles.modalTitle}>
							Open Database
						</h2>
						...
						<div style={styles.fileUpload}>
							<label className="ray-file-drop" style={styles.fileLabel}>
								Or drag & drop a .kitedb file here
								<input
									ref={fileInputRef}
									type="file"
									accept=".kitedb"
